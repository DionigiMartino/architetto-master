  ...
  const imagesCover = [
    {
      ...
      id: 1,
      title:
        "compendio immobiliare austriaco dell'Arsenale Franz Joseph I- 1°Lotto (VR)",
      import: "6.745.080,42",
      size: "big",
      description:
    ...
    },
    {
      ...
      cover: cover7,
      size: "big",
      title: "Caserma Santa Barbara - Milano (MI)",
      import: "9.012.518,88",
      description:
    ...
    },
    {
      ...
      cover: cover4,
      size: "big",
      title: "Scuola Media Dante Alighieri (PU)",
      import: "5.183.666,13",
      description:
    ...
    },
    {
      ...
      id: 8,
      cover: cover8,
      title: "Comprensorio Sciistico di Frabosa Soprana (CN)",
      import: "637.073,85",
      place: 2,
      description:
    ...
    },
    {
      ...
      id: 25,
      cover: cover26,
      title: "Rete di acque meteoriche frazione San Pantaleo - Olbia (OT)",
      import: "323.499,69",
      description:
    ...
    },
    {
      ...
      cover: cover12_2,
      size: "transport_2",
      title: "Scuola Primaria - Marcon (VE)",
      import: "7.415.998,80",
      description:
    ...
    },
    {
      ...
      id: 21,
      cover: cover21,
      title: "Scuola Primaria - L.Bettini | San Lorenzo in Campo (PU)",
      import: "1.160.000,00",
      description:
    ...
    },
    {
      ...
      cover: cover20,
      size: "big",
      title: "Scuola Secondaria di I° Grado - Olga e Leopoldo Jona | Asti (AT)",
      import: "8.000.000,00",
      description:
    ...
    },
    {
      ...
      size: "big",
      title:
        "Scuola Primaria Luigi Ferrari & Scuola dell'infanzia Via Gambalunga (RN)",
      import: "4.307.133,31",
      description:
    ...
    },
    {
      ...
      cover: cover15,
      size: "big",
      title: "Comprensorio Industriale Stock (TS)",
      import: "5.346.414,09",
      description:
    ...
    },
    {
      ...
      cover: cover13,
      size: "medium_2",
      title: "Immobile Comunale - Melzo (MI)",
      import: "3.236.240,82",
      description:
    ...
    },
    {
      ...
      id: 19,
      cover: cover16,
      title: "Piscina - Pré-Saint-Didier (AO)",
      import: "3.393.723,24",
      description:
    ...
    },
    {
      ...
      id: 22,
      cover: cover22,
      title: "Scuola Media - Torrenova (ME)",
      import: "1.225.273,59",
      description:
    ...
    },
    {
      ...
      id: 23,
      cover: cover23,
      title: "Edificio Scolastico G.Rivoira - Verzuolo (CN)",
      import: "5.699.853,57",
      description:
    ...
    },
    {
      ...
      id: 24,
      cover: cover24,
      title: "NUOVO POLO DIDATTICO DI SCIENZE DEL FARMACO - PAVIA (PV)",
      import: "7.611.769,82",
      description:
